#author-E/16/267
#CO224_lab4:server
#here the ids are generated incremented
...
class TaskapiImpl:
    ...
    def addTask(self, request, context):
		...
		#Ids are generated by incremented by 1
        self.id_number=self.id_number+1
        
        #add to the task list
        self.tasks.tasks.append(task_pb2.Task(id= self.id_number,description =request.description))
		#return id_number to the client from the server
        return task_pb2.Id(id= self.id_number)
